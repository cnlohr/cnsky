...
#define CSGP4_DEREF
#define CSGP4_REF
#define CSGP4_USE_FLOAT
#define CSGP4_DECORATOR
#define CSGP4_PREOUT out
...
#define radiusearthkm 6378.135	 // km
...
CSGP4_DECORATOR int sgp4init_simple
	 (
	   ...
	   SGPF xnodeo, SGPF initial_time,
#if CSGP4_HLSL
		out float3 r, out float3 v, out float3 a_alta_altp
#else
		CSGP4_PREOUT SGPF CSGP4_OUT r, CSGP4_PREOUT SGPF CSGP4_OUT v, CSGP4_PREOUT SGPF CSGP4_OUT a_alta_altp
#endif
	 )
{
	...
	SGPF aycof, con41, cc1, cc4, cc5, d2, d3, d4,
		   delmo, eta, argpdot, omgcof, sinmao = 0, t, t2cof, t3cof,
