	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f_customrendertexture IN) : SV_Target
			{
				...
				uint4 im0 = _ImportTexture.Load( int3( Coord.x * 4 + 0, Coord.y, 0 ) ) * 255.2;
				uint4 im1 = _ImportTexture.Load( int3( Coord.x * 4 + 1, Coord.y, 0 ) ) * 255.2;
				uint4 im2 = _ImportTexture.Load( int3( Coord.x * 4 + 2, Coord.y, 0 ) ) * 255.2;
				uint4 im3 = _ImportTexture.Load( int3( Coord.x * 4 + 3, Coord.y, 0 ) ) * 255.2;
