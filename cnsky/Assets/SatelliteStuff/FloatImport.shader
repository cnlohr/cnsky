		...
		Pass
		{
			...
			*/
			...
			float4 frag (v2f_customrendertexture IN) : SV_Target
			{
				...
				uint4 im0 = ColorCorrect4( _ImportTexture.Load( int3( Coord.x * 4 + 0, Coord.y, 0 ) ) ) * 255.5;
				uint4 im1 = ColorCorrect4( _ImportTexture.Load( int3( Coord.x * 4 + 1, Coord.y, 0 ) ) ) * 255.5;
				uint4 im2 = ColorCorrect4( _ImportTexture.Load( int3( Coord.x * 4 + 2, Coord.y, 0 ) ) ) * 255.5;
				uint4 im3 = ColorCorrect4( _ImportTexture.Load( int3( Coord.x * 4 + 3, Coord.y, 0 ) ) ) * 255.5;
